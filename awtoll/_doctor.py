...
interesting failures live BETWEEN them. "awtoll is installed" is not the useful
fact -- "awtoll is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awtoll needs at runtime, and a
